...
/**
 * Servlet Filter implementation class AgentAuthenticationFilter
 */
@WebFilter(urlPatterns = {"/AgentDashboard", "/NewProperty","/newProperty.jsp", "/updateProperty.jsp", "/update"})
